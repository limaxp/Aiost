...
//			30, 14, AiostEntityTypes.OWNABLE_ENDERMAN, 1200));
	...
	private static final IParticle WATER_BEAM_PARTICLE = new Particle(org.bukkit.Particle.FALLING_WATER, 5, 0.1F, 0,
			false);

	private static final IParticle FOUNTAIN_PARTICLE = new Particle(org.bukkit.Particle.FALLING_WATER, 20, 0.1F, 0,
			false);

	private static final IParticle EARTH_BEAM_PARTICLE = new DataParticle<BlockData>(org.bukkit.Particle.BLOCK, 3, 0.1F,
			0, false, Bukkit.createBlockData(Material.DIRT));

	private static final IParticle EARTH_BALL_PARTICLE = new DataParticle<BlockData>(org.bukkit.Particle.BLOCK, 10,
	...
	private static final IParticle HEAL_OTHER_PARTICLE = new Particle(org.bukkit.Particle.HAPPY_VILLAGER, 5, 0.1F, 0,
			false);
