...
public class PlayerCommands {
	...
	public static boolean lobby(CommandSender sender, Command cmd, String label, String[] args) {
	...
	public static boolean flySpeed(CommandSender sender, Command cmd, String label, String[] args) {
		if (!CommandUtil.requirePlayer(sender) || !CommandUtil.isAdmin(sender))
			return false;
	...
	public static boolean setOperator(CommandSender sender, Command cmd, String label, String[] args) {
		switch (args.length) {
		case 0:
			if (!CommandUtil.requirePlayer(sender) || !CommandUtil.isAdmin(sender))
				return false;
	...
	public static boolean removeOperator(CommandSender sender, Command cmd, String label, String[] args) {
		switch (args.length) {
		case 0:
			if (!CommandUtil.requirePlayer(sender) || !CommandUtil.isAdmin(sender))
				return false;
	...
	public static boolean setRank(CommandSender sender, Command cmd, String label, String[] args) {
		switch (args.length) {
		case 1:
	...
	public static boolean addPermission(CommandSender sender, Command cmd, String label, String[] args) {
		if (!CommandUtil.requirePlayer(sender) || !CommandUtil.isAdmin(sender))
			return false;
	...
	public static boolean setSetting(CommandSender sender, Command cmd, String label, String[] args) {
		if (!CommandUtil.requirePlayer(sender) || !CommandUtil.isAdmin(sender))
			return false;
	...
	public static boolean friendRequest(CommandSender sender, Command cmd, String label, String[] args) {
		if (!CommandUtil.requirePlayer(sender))
			return false;
	...
	public static boolean friendDecline(CommandSender sender, Command cmd, String label, String[] args) {
		if (!CommandUtil.requirePlayer(sender))
			return false;
	...
	public static boolean unfriend(CommandSender sender, Command cmd, String label, String[] args) {
		if (!CommandUtil.requirePlayer(sender))
			return false;
	...
	public static boolean invisiblesShow(CommandSender sender, Command cmd, String label, String[] args) {
		if (!CommandUtil.requirePlayer(sender) || !CommandUtil.isAdmin(sender))
			return false;
	...
	public static boolean invisiblesHide(CommandSender sender, Command cmd, String label, String[] args) {
		if (!CommandUtil.requirePlayer(sender) || !CommandUtil.isAdmin(sender))
			return false;
	...
	public static boolean disguisePlayer(CommandSender sender, Command cmd, String label, String[] args) {
		if (!CommandUtil.requirePlayer(sender))
			return false;
	...
	public static boolean disguiseAdmin(CommandSender sender, Command cmd, String label, String[] args) {
		if (!CommandUtil.requirePlayer(sender) || !CommandUtil.isAdmin(sender))
			return false;
		...
		case 1:
			...
			return setDisguise(ServerPlayer.getByPlayer((Player) sender), new DisguisePlayer(profile));
	...
	public static boolean disguiseRemove(CommandSender sender, Command cmd, String label, String[] args) {
		if (!CommandUtil.requirePlayer(sender))
			return false;
	...
	public static boolean party(CommandSender sender, Command cmd, String label, String[] args) {
		if (!CommandUtil.requirePlayer(sender))
			return false;
		if (args.length == 1) {
	...
	public static boolean partyJoin(CommandSender sender, Command cmd, String label, String[] args) {
		if (!CommandUtil.requirePlayer(sender))
			return false;
		if (args.length == 1) {
			ServerPlayer serverPlayer = ServerPlayer.getByPlayer((Player) sender);
	...
	public static boolean partyLeave(CommandSender sender, Command cmd, String label, String[] args) {
		if (!CommandUtil.requirePlayer(sender))
			return false;
	...
	public static boolean changeGamemode(CommandSender sender, Command cmd, String label, String[] args) {
		if (!CommandUtil.requirePlayer(sender) || !CommandUtil.isAdmin(sender))
			return false;
	...
	private static boolean changeGamemode(Player player, String gameModeString) {
	...
	public static boolean gamemodeCreative(CommandSender sender, Command cmd, String label, String[] args) {
		if (!CommandUtil.requirePlayer(sender) || !CommandUtil.isAdmin(sender))
			return false;
	...
	public static boolean gamemodeSurvival(CommandSender sender, Command cmd, String label, String[] args) {
		if (!CommandUtil.requirePlayer(sender) || !CommandUtil.isAdmin(sender))
			return false;
	...
	public static boolean gamemodeAdventure(CommandSender sender, Command cmd, String label, String[] args) {
		if (!CommandUtil.requirePlayer(sender) || !CommandUtil.isAdmin(sender))
			return false;
	...
	public static boolean gamemodeSpectator(CommandSender sender, Command cmd, String label, String[] args) {
		if (!CommandUtil.requirePlayer(sender) || !CommandUtil.isAdmin(sender))
			return false;
	...
	public static boolean showCredit(CommandSender sender, Command cmd, String label, String[] args) {
		if (!CommandUtil.requirePlayer(sender))
			return false;
	...
	public static boolean addCredit(CommandSender sender, Command cmd, String label, String[] args) {
		if (!CommandUtil.requirePlayer(sender) || !CommandUtil.isAdmin(sender))
			return false;
	...
	public static boolean duel(CommandSender sender, Command cmd, String label, String[] args) {
		if (!CommandUtil.requirePlayer(sender))
			return false;
		...
		if (serverPlayer1.hasCooldown(key)) {
			...
			sendDuelRequest(serverPlayer2, serverPlayer1);
		return true;
	}

	public static void sendDuelRequest(ServerPlayer serverPlayer, ServerPlayer requestServerPlayer) {
	...
	public static boolean invitePlayer(CommandSender sender, Command cmd, String label, String[] args) {
		if (!CommandUtil.requirePlayer(sender))
			return false;
		if (args.length != 1) {
			CommandUtil.sendError(sender, "Command must have 1 argument!");
	...
	public static boolean acceptInvite(CommandSender sender, Command cmd, String label, String[] args) {
		if (!CommandUtil.requirePlayer(sender))
			return false;
		if (args.length != 1) {
			CommandUtil.sendError(sender, "Command must have 1 argument!");
