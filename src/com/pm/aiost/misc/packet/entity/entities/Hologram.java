...
public class Hologram extends PacketEntity {
	...
	public Packet<?> createSpawnPacket(int index) {
		return PacketFactory.packetEntitySpawn(id + index, UUID.randomUUID(), x, y - (ABS * index), z, 0, 0,
	...
	public PacketEntityType<?> getPacketEntityType() {
		return PacketEntityTypes.HOLOGRAM;
	}
}
