...
public class PacketObjectInteractEvent extends ServerPlayerEvent implements Cancellable {

	protected PacketObject packetObject;
	private boolean cancelled;

	public PacketObjectInteractEvent(ServerPlayer serverPlayer, PacketObject packetObject) {
		super(serverPlayer);
