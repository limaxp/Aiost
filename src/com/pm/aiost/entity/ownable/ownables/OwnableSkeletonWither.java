...
public class OwnableSkeletonWither extends NoCombustSkeletonWither implements OwnableInsentient {

	private UUID ownerId;
	private int boundTime = -1;

	public OwnableSkeletonWither(EntityTypes<? extends EntitySkeletonWither> entitytypes, World world) {
		super(world);
	}

	public OwnableSkeletonWither(World world) {
		super(world);
	}
	...
	public EntityTypes<?> getCustomEntityType() {
		return AiostEntityTypes.OWNABLE_WITHER_SKELETON;
	}
}
