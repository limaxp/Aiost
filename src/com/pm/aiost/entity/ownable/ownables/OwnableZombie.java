...
public class OwnableZombie extends NoCombustZombie implements OwnableInsentient {

	private UUID ownerId;
	private int boundTime = -1;

	public OwnableZombie(EntityTypes<? extends EntityZombie> entitytypes, World world) {
		super(EntityTypes.ZOMBIE, world);
	}

	public OwnableZombie(World world) {
		super(EntityTypes.ZOMBIE, world);
	}
	...
	public EntityTypes<?> getCustomEntityType() {
		return AiostEntityTypes.OWNABLE_ZOMBIE;
	}
}
