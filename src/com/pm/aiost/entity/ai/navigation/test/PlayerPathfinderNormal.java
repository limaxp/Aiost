...
public class PlayerPathfinderNormal extends PlayerPathfinderAbstract {
    ...
    private PathType a(NpcInsentient var0, BlockPosition var1) {
        return this.a(var0, var1.getX(), var1.getY(), var1.getZ());
    }

    private PathType a(NpcInsentient var0, int var1, int var2, int var3) {
    ...
    public PathType a(IBlockAccess var0, int var1, int var2, int var3, NpcInsentient var4, int var5, int var6,
            ...
            if (var11 == PathType.WALKABLE) {
                ...
                if (var11 == PathType.OPEN) {
                    ...
                    while (var11 == PathType.OPEN) {
                        ...
                        if (var16++ >= 16) { // TODO MAX fall distance here!
                            var18.l = PathType.BLOCKED;
                            var18.k = -1.0F;
                            return var18;
                        }
