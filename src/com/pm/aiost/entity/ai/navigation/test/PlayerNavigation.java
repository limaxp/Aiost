...
public class PlayerNavigation extends NavigationAbstract {
	protected final NpcInsentient a;
	...
	public PlayerNavigation(NpcInsentient entityinsentient, World world) {
	...
	private static EntityInsentient getDummyInsentient(NpcInsentient from, World world) {
