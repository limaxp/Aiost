...
public class HostileBee extends EntityBee implements AiostInsentient {

	public HostileBee(EntityTypes<? extends EntityBee> entitytypes, World world) {
		super(EntityTypes.BEE, world);
	}

	public HostileBee(World world) {
		super(EntityTypes.BEE, world);
	}
	...
	protected void initPathfinder() {
		...
		this.targetSelector.a(2, new PathfinderGoalNearestAttackableTarget(this, EntityBee.class, false));
	}
	...
	public EntityTypes<?> getCustomEntityType() {
		return AiostEntityTypes.HOSTILE_BEE;
	}
}
