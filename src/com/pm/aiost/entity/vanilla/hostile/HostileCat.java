...
public class HostileCat extends EntityWolf implements AiostInsentient {

	public HostileCat(EntityTypes<? extends EntityWolf> entitytypes, World world) {
		super(EntityTypes.WOLF, world);
	}

	public HostileCat(World world) {
		super(EntityTypes.WOLF, world);
	}
	...
	protected void initPathfinder() {
		...
		this.targetSelector.a(2, new PathfinderGoalNearestAttackableTarget(this, EntityCat.class, false));
	}
	...
	protected SoundEffect getSoundAmbient() {
		return SoundEffects.ENTITY_CAT_AMBIENT;
	}
	...
	public EntityTypes<?> getCustomEntityType() {
		return AiostEntityTypes.HOSTILE_CAT;
	}
}
