...
public class HostileWolf extends EntityWolf implements AiostInsentient {

	public HostileWolf(EntityTypes<? extends EntityWolf> entitytypes, World world) {
		super(EntityTypes.WOLF, world);
	}

	public HostileWolf(World world) {
		super(EntityTypes.WOLF, world);
	}
	...
	protected void initPathfinder() {
		...
		this.targetSelector.a(2, new PathfinderGoalNearestAttackableTarget(this, EntityWolf.class, false));
	}
	...
	public EntityTypes<?> getCustomEntityType() {
		return AiostEntityTypes.HOSTILE_WOLF;
	}
}
