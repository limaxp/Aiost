...
public class HostileRabbit extends EntitySilverfish implements AiostInsentient {

	public HostileRabbit(EntityTypes<? extends EntitySilverfish> entitytypes, World world) {
		super(EntityTypes.SILVERFISH, world);
	}

	public HostileRabbit(World world) {
		super(EntityTypes.SILVERFISH, world);
	}
	...
	protected void initPathfinder() {
		...
		this.targetSelector.a(2, new PathfinderGoalNearestAttackableTarget(this, EntityRabbit.class, false));
	}
	...
	public EntityTypes<?> getCustomEntityType() {
		return AiostEntityTypes.HOSTILE_RABBIT;
	}
}
