...
public class HostileBat extends EntityBee implements AiostInsentient {

	public HostileBat(EntityTypes<? extends EntityBee> entitytypes, World world) {
		super(EntityTypes.BEE, world);
	}

	public HostileBat(World world) {
		super(EntityTypes.BEE, world);
	}
	...
	protected void initPathfinder() {
		...
		this.targetSelector.a(2, new PathfinderGoalNearestAttackableTarget(this, EntityBat.class, false));
	}
	...
	public EntityTypes<?> getCustomEntityType() {
		return AiostEntityTypes.HOSTILE_BAT;
	}
}
