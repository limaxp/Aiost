...
public class HostileFox extends EntityWolf implements AiostInsentient {

	public HostileFox(EntityTypes<? extends EntityWolf> entitytypes, World world) {
		super(EntityTypes.WOLF, world);
	}

	public HostileFox(World world) {
		super(EntityTypes.WOLF, world);
	}
	...
	protected void initPathfinder() {
		...
		this.targetSelector.a(2, new PathfinderGoalNearestAttackableTarget(this, EntityFox.class, false));
	}
	...
	public EntityTypes<?> getCustomEntityType() {
		return AiostEntityTypes.HOSTILE_FOX;
	}
}
