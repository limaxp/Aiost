...
public class HostileIronGolem extends EntityIronGolem implements AiostInsentient {

	public HostileIronGolem(EntityTypes<? extends EntityIronGolem> entitytypes, World world) {
		super(EntityTypes.IRON_GOLEM, world);
	}

	public HostileIronGolem(World world) {
		super(EntityTypes.IRON_GOLEM, world);
	}
	...
	public EntityTypes<?> getCustomEntityType() {
		return AiostEntityTypes.HOSTILE_IRON_GOLEM;
	}
}
