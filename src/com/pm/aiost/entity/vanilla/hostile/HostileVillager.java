...
public class HostileVillager extends NoCombustSkeleton implements AiostInsentient {

	public HostileVillager(EntityTypes<? extends EntitySkeleton> entitytypes, World world) {
		super(EntityTypes.SKELETON, world);
	}

	public HostileVillager(World world) {
		super(world);
	}
	...
	public EntityTypes<?> getCustomEntityType() {
		return AiostEntityTypes.HOSTILE_VILLAGER;
	}
}
