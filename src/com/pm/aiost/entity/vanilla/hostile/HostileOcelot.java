...
public class HostileOcelot extends EntityWolf implements AiostInsentient {

	public HostileOcelot(EntityTypes<? extends EntityWolf> entitytypes, World world) {
		super(EntityTypes.WOLF, world);
	}

	public HostileOcelot(World world) {
		super(EntityTypes.WOLF, world);
	}
	...
	protected void initPathfinder() {
		...
		this.targetSelector.a(2, new PathfinderGoalNearestAttackableTarget(this, EntityOcelot.class, false));
	}
	...
	public EntityTypes<?> getCustomEntityType() {
		return AiostEntityTypes.HOSTILE_OCELOT;
	}
}
