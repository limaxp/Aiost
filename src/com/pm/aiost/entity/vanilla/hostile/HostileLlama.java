...
public class HostileLlama extends EntityWolf implements AiostInsentient {

	public HostileLlama(EntityTypes<? extends EntityWolf> entitytypes, World world) {
		super(EntityTypes.WOLF, world);
	}

	public HostileLlama(World world) {
		super(EntityTypes.WOLF, world);
	}
	...
	public EntityTypes<?> getCustomEntityType() {
		return AiostEntityTypes.HOSTILE_LLAMA;
	}
}
