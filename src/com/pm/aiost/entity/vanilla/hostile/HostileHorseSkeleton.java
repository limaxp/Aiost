...
public class HostileHorseSkeleton extends EntityWolf implements AiostInsentient {

	public HostileHorseSkeleton(EntityTypes<? extends EntityWolf> entitytypes, World world) {
		super(EntityTypes.WOLF, world);
	}

	public HostileHorseSkeleton(World world) {
		super(EntityTypes.WOLF, world);
	}
	...
	protected SoundEffect getSoundAmbient() {
		return SoundEffects.ENTITY_SKELETON_HORSE_AMBIENT;
	}
	...
	public EntityTypes<?> getCustomEntityType() {
		return AiostEntityTypes.HOSTILE_SKELETON_HORSE;
	}
}
