...
public class HostileTurtle extends EntitySilverfish implements AiostInsentient {

	public HostileTurtle(EntityTypes<? extends EntitySilverfish> entitytypes, World world) {
		super(EntityTypes.SILVERFISH, world);
	}

	public HostileTurtle(World world) {
		super(EntityTypes.SILVERFISH, world);
	}
	...
	protected void initPathfinder() {
		...
		this.targetSelector.a(2, new PathfinderGoalNearestAttackableTarget(this, EntityTurtle.class, false));
	}
	...
	protected SoundEffect getSoundHurt(DamageSource damagesource) {
		return SoundEffects.ENTITY_TURTLE_HURT;
	}

	protected SoundEffect getSoundDeath() {
		return SoundEffects.ENTITY_TURTLE_DEATH;
	}
	...
	public EntityTypes<?> getCustomEntityType() {
		return AiostEntityTypes.HOSTILE_TURTLE;
	}
}
