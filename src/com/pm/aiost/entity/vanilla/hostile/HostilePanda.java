...
public class HostilePanda extends EntityPanda implements AiostInsentient {

	public HostilePanda(EntityTypes<? extends EntityPanda> entitytypes, World world) {
		super(EntityTypes.PANDA, world);
	}

	public HostilePanda(World world) {
		super(EntityTypes.PANDA, world);
	}
	...
	protected void initPathfinder() {
		...
		this.targetSelector.a(2, new PathfinderGoalNearestAttackableTarget(this, EntityPanda.class, false));
	}
	...
	public EntityTypes<?> getCustomEntityType() {
		return AiostEntityTypes.HOSTILE_PANDA;
	}
}
