...
public class HostileChicken extends EntitySilverfish implements AiostInsentient {

	public HostileChicken(EntityTypes<? extends EntitySilverfish> entitytypes, World world) {
		super(EntityTypes.SILVERFISH, world);
	}

	public HostileChicken(World world) {
		super(EntityTypes.SILVERFISH, world);
	}
	...
	public EntityTypes<?> getCustomEntityType() {
		return AiostEntityTypes.HOSTILE_CHICKEN;
	}
}
