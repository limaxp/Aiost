...
public class HostileSheep extends EntityWolf implements AiostInsentient {

	public HostileSheep(EntityTypes<? extends EntityWolf> entitytypes, World world) {
		super(EntityTypes.WOLF, world);
	}

	public HostileSheep(World world) {
		super(EntityTypes.WOLF, world);
	}
	...
	protected void initPathfinder() {
		...
		this.targetSelector.a(2, new PathfinderGoalNearestAttackableTarget(this, EntitySheep.class, false));
	}
	...
	public EntityTypes<?> getCustomEntityType() {
		return AiostEntityTypes.HOSTILE_SHEEP;
	}
}
