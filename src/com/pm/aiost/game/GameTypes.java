...
public class GameTypes {
	...
	public static final GameType<Spleef> SPLEEF = register("Spleef",
	...
	public static final GameType<CastleDefend> CASTLE_DEFEND = register("Castle Defend",
	...
	public static final GameType<TntThrow> TNT_THROW = register("Tnt Thrower",
	...
	public static final GameType<Soccer> SOCCER = register("Soccer", new String[] { "A simple game of soccer" }, 2, 12,
			new ItemStack(Material.CLAY_BALL), Soccer::new, (serverWorld) -> null);

	public static <T extends Game> GameType<T> register(String name, String[] lore, int minPlayer, int maxPlayer,
			ItemStack is, Supplier<T> constructor, Function<ServerWorld, String> requireFunction) {
